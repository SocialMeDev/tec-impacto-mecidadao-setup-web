...
const SunOutlineIcon = createIcon({
  displayName: 'SunOutlineIcon',
  viewBox: '0 0 24 24',
  path: (
    <>
...
const SunOutline: FC<IconProps> = (props) => {
  return <CustomIcon as={SunOutlineIcon} {...props} />
}

export default memo(SunOutline)
