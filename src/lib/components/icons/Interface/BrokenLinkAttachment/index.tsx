...
const BrokenLinkAttachmentIcon = createIcon({
  displayName: 'BrokenLinkAttachmentIcon',
  viewBox: '0 0 24 24',
  path: (
    <>
...
const BrokenLinkAttachment: FC<IconProps> = (props) => {
  return <CustomIcon as={BrokenLinkAttachmentIcon} {...props} />
}

export default memo(BrokenLinkAttachment)
